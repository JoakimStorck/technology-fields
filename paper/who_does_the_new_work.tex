...
Section~\ref{sec:cognitive} reports the results, and confronts the seeding
...
and what the data pin is the field's value where work is rather than the
...
rule rather than a moment, and its wage cross-section falls in a window
...
a property of where the cognitive field happens to sit. What does depend
on position is the price of the work a wave destroys, and that is what
separates a wave the wage data barely register from one this model says
will be felt.
