...
trades down, at $0.59$ to one. Automation costs wages when it destroys
work dearer than the work it creates, and in this model the geometry
decides which.
...
property of where the cognitive field happens to sit. What position does
govern is the price of the work a wave destroys, and that is the
difference between a wave the wage record barely registers and one this
model says will be felt.
