...
The reduced form is not atheoretic, and the choice to hold it fixed is
not an admission that it means nothing.
...
repricing.} Nor is it an artefact of pooling:
Appendix~\ref{app:geometry-robustness} re-estimates the directional
depth return sector by sector on the frozen inputs.
