...
occupational cross-section cannot tell them apart. The window of
Section~\ref{sec:robot-data} could, and did.
...
rental rule implies, and the two columns are not on one scale. What is
comparable is everything else.
