...
$\chi_K = 0.75$, reach $0.50$, and $z_K = 0.84$. Its amplitude is a
modelling rule of the same kind that sets $R$: $A_K = 1.2$ opens the
gate moderately in the west, and the same constants carry through the
checks of Section~\ref{sec:directional-check}; a calibration of the
gate to the aggregate displacement of \textcite{acemoglu2020robots}
...
We run the cognitive field through the calibrated economy. The
