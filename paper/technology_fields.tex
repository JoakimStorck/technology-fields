...
\subsection{External validation: where new firms appear}
...
unbound field $u(\mathbf r)$, the model's bound reinstatement, and the
AI and robotics firms all peak near $z_K$. The unbound share of seeded
