...
carry through the placebo of Section~\ref{sec:directional-check}. The
...
capabilities the seeded tasks require are scarce. The geometry therefore
implies weak binding for robot reinstatement and little offsetting
employment, consistent with the absence of positive employment effects
outside the exposed region documented by \textcite{acemoglu2020robots}.
The implication is read off the field's position; the robot field is
not run through the equilibrium here.
